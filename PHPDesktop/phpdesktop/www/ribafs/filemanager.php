...
$CONFIG = '{"lang":"pt","error_reporting":false,"show_hidden":false,"hide_Cols":false,"calc_folder":false}';
...
$auth_users = array(
    'admin' => '$2y$10$En437nsGdHXC9fyTHFUaz.xeTYF97FUVJyy7M6RYqLzTwkJ.47cbe', // login - admin, senha - admin
    'ribafs' => '$2y$10$F0zUn3ILE1a/kPkj2Nlk0OOUtfnjFXd9y3oJpwfH5yUbuONUGkOty'
);
...
$root_path = $_SERVER['DOCUMENT_ROOT'].CURRENT;

if(!file_exists($root_path)) {
    print '<h3>Precisa alterar a linha 17 do index.php<br>para entrar com pasta onde instalou o filemanager</h3>';
    exit();
}
                        ...
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    ...
                                    <hr />
<div class="text-center">Login - admin. Senha - admin</div>
                                    <div class="form-group">
